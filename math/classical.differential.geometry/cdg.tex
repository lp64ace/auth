...
Έστω $\sigma : I \to I$, με $\sigma(t^*) = t$ υποθέτοντας ότι $\sigma : \dv{\sigma}{t} \ne 0$ γνησίος μονότονη και επί τότε η $\overrightarrow{x} \circ \sigma(t^*) = \overrightarrow{x}$ είναι καμπύλη με το ίδιο ίχνος με την καμπύλη που παραμετροποιείται από την $\overrightarrow{x}(t)$, αλλά η παραμέτρηση τώρα εξαρτάται από την $t^*$.

Αν εξετάσω τι συμβαίνει με τα εφαπτόμενα διανύσματα ως προς το $t$ και ώς προς το $t^*$, \\

$\dv{\overrightarrow{x}}{t^*} = \dv{\overrightarrow{x} \circ \sigma}{t^*} = \dv{\overrightarrow{x}}{t} \dv{\sigma}{t^*} = \dv{\overrightarrow{x}}{t} \sigma'(t^*)$.

Αν η καμπύλη λοιπόν που ορίζεται από την $\overrightarrow{x}$ είναι ομάλή τότε $\forall t \in I, \dv{\overrightarrow{x}}{t} \ne 0$ και αφού $\sigma(t^*)$ είναι λεία και μονότονη τότε επίσης $\sigma'(t^*) \ne 0$ άρα αν η $\overrightarrow{x}$ ομαλή τότε και η $\overrightarrow{x} \circ \sigma(t^*)$ ομαλή.
