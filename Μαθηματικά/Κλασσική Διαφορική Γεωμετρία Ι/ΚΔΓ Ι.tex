...
Αποτέλεσμα $rank(\mathbf{B'}) \ne 0$ άρα $u, v, w$ γραμμικά ανεξάρτητα και άρα $span(u, v, w) = \mathbb{R}^3$ οπότε τα $u, v, w$ αποτελούν βάση του $\mathbb{R}^3$ και άρα $B = \{u, v, w\}$ βάση.
